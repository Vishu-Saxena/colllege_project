...
<body>
    <div class="wrapper"> 
        <div class="main" id="tc">
            ...
            <form action="rejecttc.php"  method="post"  enctype ="multipart/form-data">
                <div class="content">
                    <div class="row">
                        <div class="heading">
                        ...
                        <div class="w1">
                            ...
                            <div class="w1">
                                ...
                                <div class="ww1" id="btn">
                                    <button type="submit"><a style="color:white;" href="rejecttc.php?id=<?php echo $sn;?>">Reject</a></button>
                                </div>
